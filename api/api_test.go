...
func TestCORS(t *testing.T) {
	...
	cases := []struct {
		...
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "http://example.com", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "http://example.com:80", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "http://example.com:443", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "https://example.com", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "https://example.com:80", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "https://example.com:443", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "http://localhost", "http://localhost"},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "http://localhost:8080", "http://localhost:8080"},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "http://mozilla.github.io", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "http://mozilla.github.io:80", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "http://mozilla.github.io:443", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "https://mozilla.github.io", "https://mozilla.github.io"},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "https://mozilla.github.io:80", "https://mozilla.github.io:80"},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodGet, "https://mozilla.github.io:443", "https://mozilla.github.io:443"},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodOptions, "http://localhost", "http://localhost"},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodOptions, "http://example.com", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodOptions, "https://example.com", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodOptions, "http://mozilla.github.io", ""},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodOptions, "https://mozilla.github.io", "https://mozilla.github.io"},
		{"Preloadable", api.Preloadable().ServeHTTP, http.MethodPost, "https://mozilla.github.io", "https://mozilla.github.io"},
		{"Status", api.Status().ServeHTTP, http.MethodGet, "http://localhost:8080", "http://localhost:8080"},
		{"Status", api.Status().ServeHTTP, http.MethodGet, "http://example.com", ""},
		{"Status", api.Status().ServeHTTP, http.MethodGet, "https://example.com", ""},
		{"Status", api.Status().ServeHTTP, http.MethodGet, "http://mozilla.github.io", ""},
		{"Status", api.Status().ServeHTTP, http.MethodGet, "https://mozilla.github.io", "https://mozilla.github.io"},
		{"Status", api.Status().ServeHTTP, http.MethodOptions, "http://localhost:8080", "http://localhost:8080"},
		{"Status", api.Status().ServeHTTP, http.MethodOptions, "http://example.com", ""},
		{"Status", api.Status().ServeHTTP, http.MethodOptions, "https://example.com", ""},
		{"Status", api.Status().ServeHTTP, http.MethodOptions, "http://mozilla.github.io", ""},
		{"Status", api.Status().ServeHTTP, http.MethodOptions, "https://mozilla.github.io", "https://mozilla.github.io"},
